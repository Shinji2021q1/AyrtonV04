...
let menu =`
╭══〘 ✯✯✯✯✯✯✯✯ 〙═╮
║═ *𝕶𝖎𝖓𝖌 𝕾𝖍𝖆𝖉𝖔𝖜 𝕸𝖔𝖓𝖆𝖗𝖈𝖍 - 𝐁𝐨𝐭*
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡
║➤ *✨𝗛ola, ${username}!!*
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡
║➤ *Creador del Bot: Ayrton Gerald* 
║➤ *Numero del creador:* *wa.me/51936448126 (No Bot)*
║➤ *PayPal:* *Proximamente*
║➤ *Numero del Bot oficial:* *Proximamente*
║➤ *Numero del Sub Bot oficial:* *Proximamente*
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡
╰══╡✯✯✯✯✯✯✯✯╞══╯
┏━━━━━━━━━━━━━┓
┃ *<INFORMACIÓN|MENUS/>*
...
conn.send3ButtonImg(m.chat, pp, menu, '©King Shadow Monarch - Bot', '𝙼𝙴𝙽𝚄 𝚂𝙸𝙼𝙿𝙻𝙴', `#menusimple`, '𝙼𝙴𝙽𝚄 𝙰𝚄𝙳𝙸𝙾𝚂', `#menuaudios`, '𝙶𝚁𝚄𝙿𝙾𝚂 𝙾𝙵𝙸𝙲𝙸𝙰𝙻𝙴𝚂', `#grupos`, m, false, { contextInfo: { mentionedJid }})   
